...
Cursor HTTP: `"url": "http://127.0.0.1:10889/mcp"`.  
...
| Mode | How | Cursor |
| --- | --- | --- |
| **HTTP** (Docker / Hub) | `make mcp-http` | `"url": "http://127.0.0.1:10889/mcp"` |
...
kms-secp256k1-api-mcp --http                  # 127.0.0.1:10889
kms-secp256k1-api-mcp --http --listen 0.0.0.0:10889
```
...
| `make mcp-http` | Pull Hub image (or build) + start sidecar on **10889** |
...
| `make run-mcp-http` | Host HTTP on `127.0.0.1:10889` |
