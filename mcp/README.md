...
| **HTTP (host)** | `make run-mcp-http` | Streamable HTTP on **9789** |
| **HTTP (Docker)** | `make mcp-http` | Pull Hub (or build) + compose on **9789** → `http://127.0.0.1:9789/mcp` |
...
| `KMS_MCP_ADDR` | `127.0.0.1:9789` | HTTP listen address |
